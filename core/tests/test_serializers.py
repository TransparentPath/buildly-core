...
def test_org_serializer(request_factory, org):
    ...
    keys = [
        ...
        'default_shock',
        'default_light',
        'default_pre_transit_transmission_interval',
        'default_pre_transit_measurement_interval',
        'default_transit_transmission_interval',
        'default_transit_measurement_interval',
        'default_post_transit_transmission_interval',
        'default_post_transit_measurement_interval',
